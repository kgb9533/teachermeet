  ...
  return (
    <div style={styles.container}>
      ...
      <div style={styles.content}>
        ...
        <ul style={styles.ul}>
          <li>전액 환불(제1조): 결제 수수료를 제외한 금액 전액 환불 (PG사 수수료 약 3.3%)</li>
          <li>부분 환불(제2조): 잔여 EDU 환산 금액의 <strong>10%</strong> 또는 1,000원 중 큰 금액을 수수료로 차감</li>
          <li>회원의 단순 변심에 의한 환불 신청 시 위 수수료 기준을 적용합니다.</li>
        </ul>
